...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QLineEdit, QPushButton  # PyQt5의 주요 위젯을 임포트
...
if __name__ == "__main__":
    ...
    api_key = "AIzaSyCJjpyQ1_1dhC_IyXeS3Gg_BCckVmcuYx8"  # Google Maps API 키 (실제 키로 교체 필요)
